		...
		<table class="auto-style3" style="width: 100%">
			<tr>
				<td><span class="auto-style2">ANAK LAMPIRAN 1.b<br />
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Banjarmasin,
						{{\Carbon\Carbon::parse($cuti->created_at)->isoFormat('D MMMM Y')}}<br />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						Kepada<br />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Yth. Kepala
		...
		<div class="auto-style9">
			...
			<table cellpadding="2" cellspacing="0" class="auto-style5" style="width: 47%">
				...
				<tr style="font-size:12px; font-family:Arial, Helvetica, sans-serif">
					...
					<td class="auto-style1" style="width: 182px;text-align:center;">{{$cuti->jenis_cuti_id == 1 ?
						'V':'-'}}</td>
					<td class="auto-style6" style="width: 163px">2. Cuti Besar</td>
					<td class="auto-style1" style="width: 155px;text-align:center;">{{$cuti->jenis_cuti_id == 2 ?
						'V':'-'}}</td>
				</tr>
				<tr style="font-size:12px; font-family:Arial, Helvetica, sans-serif">
					<td class="auto-style6" style="width: 148px">3. Cuti Sakit</td>
					<td class="auto-style1" style="width: 182px;text-align:center;">{{$cuti->jenis_cuti_id == 3 ?
						'V':'-'}}</td>
					<td class="auto-style6" style="width: 163px">4. Cuti Melahirkan</td>
					<td class="auto-style1" style="width: 155px;text-align:center;">{{$cuti->jenis_cuti_id == 4 ?
						'V':'-'}}</td>
				</tr>
				<tr style="font-size:12px; font-family:Arial, Helvetica, sans-serif">
					<td class="auto-style6" style="width: 148px">5. Cuti Karena
						Alasan Penting</td>
					<td class="auto-style1" style="width: 182px;text-align:center;">{{$cuti->jenis_cuti_id == 5 ?
						'V':'-'}}</td>
					<td class="auto-style6" style="width: 163px">6. Cuti Diluar
						Tanggungan Negara</td>
					<td class="auto-style1" style="width: 155px;text-align:center;">{{$cuti->jenis_cuti_id == 6 ?
						'V':'-'}}</td>
				</tr>
			</table>
			...
			<table cellpadding="2" cellspacing="0" class="auto-style5" style="width: 47%">
				...
				<tr class="auto-style2" style="font-size:12px; font-family:Arial, Helvetica, sans-serif">
					...
					<td class="auto-style6" style="width: 163px">mulai tanggal :
						{{\Carbon\Carbon::parse($cuti->mulai)->format('d/m/Y')}}</td>
					<td class="auto-style1" style="width: 155px">s/d
						{{\Carbon\Carbon::parse($cuti->sampai)->format('d/m/Y')}}</td>
				</tr>
			</table>
			...
			<table cellpadding="2" cellspacing="0" class="auto-style5" style="width: 47%">
				...
				<tr class="auto-style2" style="font-size:12px; font-family:Arial, Helvetica, sans-serif">
					...
					<td class="auto-style1" style="width: 73px">{{$cuti->n2}}</td>
				...
				<tr class="auto-style2" style="font-size:12px; font-family:Arial, Helvetica, sans-serif">
					...
					<td class="auto-style1" style="width: 73px">{{$cuti->n1}}</td>
					<td class="auto-style1" style="width: 26px">&nbsp;</td>
				...
				<tr class="auto-style2" style="font-size:12px; font-family:Arial, Helvetica, sans-serif">
					...
					<td class="auto-style1" style="width: 73px">{{$cuti->n}}</td>
					<td class="auto-style1" style="width: 26px">&nbsp;</td>
			...
			<table cellpadding="2" cellspacing="0" class="auto-style5" style="width: 47%">
				...
				<tr class="auto-style2" style="font-size:12px; font-family:Arial, Helvetica, sans-serif">
					<td class="auto-style6" style="height: 46px;" colspan="2">
						...
						Hormat Saya,<br /><br />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<img src="{{$cuti->ttd}}" width="80px" height="50px"><br />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						({{dataPegawai($cuti->nip)->nama}})<br />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						NIP. {{$cuti->nip}}
					</td>
				</tr>
			...
			<table cellpadding="2" cellspacing="0" class="auto-style5" style="width: 47%">
				...
				<tr class="auto-style2" style="font-size:12px; font-family:Arial, Helvetica, sans-serif">
					<td class="auto-style8" style="width: 148px; text-align:center">{{$cuti->verifikasi_atasan ==
						"disetujui" ? 'V':''}}</td>
					<td class="auto-style7" style="width: 182px">&nbsp;</td>
					<td class="auto-style8" style="width: 163px">&nbsp;</td>
					<td class="auto-style7" style="width: 155px; text-align:center">{{$cuti->verifikasi_atasan ==
						"ditolak" ? 'V':''}}</td>
				</tr>
				<tr class="auto-style2" style="font-size:12px; font-family:Arial, Helvetica, sans-serif">
			...
			<table cellpadding="2" cellspacing="0" class="auto-style5" style="width: 47%">
				...
				<tr class="auto-style2">
					<td class="auto-style8" style="width: 148px; text-align:center">{{$cuti->verifikasi_kadis ==
						"disetujui" ? 'V':''}}</td>
					<td class="auto-style7" style="width: 182px">&nbsp;</td>
					<td class="auto-style8" style="width: 163px">&nbsp;</td>
					<td class="auto-style7" style="width: 155px; text-align:center">{{$cuti->verifikasi_kadis ==
						"ditolak" ? 'V':''}}</td>
				</tr>
			</table>
