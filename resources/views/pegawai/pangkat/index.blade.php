...
<section class="content">
  <div class="row">
    ...
    <a href="/pegawai/pangkat/add" class="btn btn-sm bg-purple"><i class="fa fa-plus"></i> Tambah</a> <br/><br/>
    <div class="box">
      ...
      <div class="box-body table-responsive table-bordered table-condensed">
        <table class="table table-hover">
          ...
          <tr>
            ...
            <td>
              <table>
                @if ($item->kode_unitkerja == '170032' || $item->kode_unitkerja == '170031' || $item->kode_unitkerja == '170030' || $item->verifikasi_unitkerja == '170029')
            ...
            <td>
              ...
              <a href="/pegawai/pangkat/delete/{{$item->id}}"
...
<div class="modal fade" id="modal-file">
  <div class="modal-dialog">
      <div class="modal-content">
          <form role="form" method="post" action="/pegawai/pangkat/upload" enctype="multipart/form-data">
              @csrf
