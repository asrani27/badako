  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box-header with-border">
        <h3 class="box-title">Formulir Permohonan Kenaikan Pangkat</h3>
      </div>
      <div class="box-body">
        <form class="form-horizontal" action="/pegawai/pangkat/add" method="post" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group">
            <label for="inputName" class="col-sm-2 control-label text-right">JENIS KENAIKAN PANGKAT</label>
            <div class="col-sm-10">
