  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <form method="get" action="/admin/cuti/filter">
        ...
        <div class="col-md-1">
          <button type="submit" class="btn btn-sm btn-primary" value="cari" name="button"><i
              class="fa fa-search"></i></button>
          <button type="submit" class="btn btn-sm btn-primary" value="cetak" name="button"><i
            ...
            <form method="get" action="/admin/cuti/search">
              ...
              <div class="input-group input-group-sm hidden-xs" style="width: 250px;">
                <input type="text" name="search" class="form-control pull-right" value="{{old('search')}}"
                  placeholder="Cari NIP/NIK/Nama" required>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="#" class="btn btn-xs btn-success modal-nsisa" data-id="{{$item->id}}" data-n="{{$item->n}}"
                    data-n1="{{$item->n1}}" data-n2="{{$item->n2}}"><i class="fa fa-edit"></i></a>
                </td>
                <td>
                  <table border="0">
                    ...
                    <tr>
                      ...
                      <td>: {{checkPegawai($item->atasan_langsung)}} <a href="/admin/cuti/ganti-atasan/{{$item->id}}"
                          class="text-primary" target="_blank"><i class="fa fa-edit"></i></a></td>
                    </tr>
                ...
                <td>
                  ...
                  <a href="/admin/cuti/teruskan/{{$item->id}}" onclick="return confirm('validasi Data');"
                    class="btn btn-xs btn-flat  btn-success">verifikasi</a>
                  @else
                  @endif

                  <a href="/admin/cuti/delete/{{$item->id}}" onclick="return confirm('Yakin ingin di hapus');"
                    class="btn btn-xs btn-flat  btn-danger"><i class="fa fa-trash"></i></a>
                  <a href="/admin/cuti/pdf/{{$item->id}}" class="btn btn-xs btn-flat  btn-danger" target="_blank"><i
