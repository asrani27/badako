...
<li class="{{ (request()->is('pegawai/pangkat')) ? 'active' : '' }}"><a href="/pegawai/pangkat"><i class="fa fa-paper-plane"></i> <span><i>Pangkat</i></span></a></li>
...
<li class="{{ (request()->is('pegawai/pangkat/verifikasi')) ? 'active' : '' }}"><a href="/pegawai/pangkat/verifikasi"><i class="fa fa-edit"></i> <span><i>Verif Naik Pangkat Sbg Atasan</i></span>
    <span class="pull-right-container"> 
        @if (pangkat_sebagai_atasan() != 0)
        <small class="label pull-right bg-red">{{pangkat_sebagai_atasan()}}</small>
        @endif
    </span>
</a></li>

@if (\App\Models\Kadis::where('nip', Auth::user()->username)->first() != null)
<li class="{{ (request()->is('pegawai/pangkat/verifikasi_kadis')) ? 'active' : '' }}"><a href="/pegawai/pangkat/verifikasi_kadis"><i class="fa fa-edit"></i> <span><i>Verif Naik Pangkat Sbg Kadis</i></span>
    <span class="pull-right-container"> 
        @if (pangkat_sebagai_kadis() != 0)
        <small class="label pull-right bg-red">{{pangkat_sebagai_kadis()}}</small>
        @endif
    </span>
</a></li>
@endif
...
@if (\App\Models\Sekretaris::where('nip', Auth::user()->username)->first() != null)
<li class="{{ (request()->is('pegawai/pangkat/verifikasi_sekretaris')) ? 'active' : '' }}"><a href="/pegawai/pangkat/verifikasi_sekretaris"><i class="fa fa-edit"></i> <span><i>Verif Naik Pangkat Sbg Sekretaris</i></span>
    <span class="pull-right-container"> 
        @if (pangkat_sebagai_sekre() != 0)
        <small class="label pull-right bg-red">{{pangkat_sebagai_sekre()}}</small>
        @endif
    </span>
</a></li>
@endif
