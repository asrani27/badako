...
<div class="row">
  <div class="col-xs-12">
    <a href="/superadmin/data/liburnasional/add" class="btn btn-sm bg-purple"><i class="fa fa-user-plus"></i> Tambah</a>
    <div class="box">
      <div class="box-header">
        <h3 class="box-title"><i class="fa fa-clipboard"></i> Data Libur Nasional</h3>
          ...
          <tr>
              ...
              <td>                  
                {{-- <a href="/superadmin/data/liburnasional/profile/{{$item->id}}" class="btn btn-xs btn-flat  btn-success"><i class="fa fa-user"></i> profile </a> --}}
                  ...
                  <a href="/superadmin/data/liburnasional/delete/{{$item->id}}"
