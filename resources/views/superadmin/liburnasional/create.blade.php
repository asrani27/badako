...
<div class="row">
  <div class="col-xs-12">
    <a href="/superadmin/data/liburnasional" class="btn btn-sm bg-purple"><i class="fa fa-arrow-left"></i> Kembali</a>
    <br/><br/>
    <div class="box">
      ...
      <form class="form-horizontal" action="/superadmin/data/liburnasional/add" method="post">
        @csrf
        <div class="box-body">
