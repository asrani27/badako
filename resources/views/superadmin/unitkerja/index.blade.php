...
<div class="row">
  <div class="col-xs-12">
    <a href="/superadmin/data/unitkerja/add" class="btn btn-sm bg-purple"><i class="fa fa-user-plus"></i> Tambah</a>
    <a href="/superadmin/data/unitkerja/kode" class="btn btn-sm bg-purple"><i class="fa fa-user-refresh"></i> Generate Kode</a>
    <a href="/superadmin/data/unitkerja/akun" class="btn btn-sm bg-purple"><i class="fa fa-key"></i> Buat Akun </a> <br/><br/>
    <div class="box">
          ...
          <tr>
              ...
              <td>                  
                {{-- <a href="/superadmin/data/unitkerja/profile/{{$item->id}}" class="btn btn-xs btn-flat  btn-success"><i class="fa fa-user"></i> profile </a> --}}
                  <a href="/superadmin/data/unitkerja/edit/{{$item->id}}" class="btn btn-xs btn-flat  btn-success"><i class="fa fa-edit"></i></a>
